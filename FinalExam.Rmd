...
## $p.value
## [1] 0.9498592
• Rˆ2 is called the coefficient of determination and it is usually used as a measure of the effect size. Conduct another power analysis that shows the numimum effect size needed to achieve 80% power using N = 20.
...
##Drawing the line and equationfor a correlation
```{r}
var1 <- rnorm(100)
