...
A larger sample size increases the absolute value of the t-value because you are increasing the amplification of the effect size. The larger the standard deviation decreases the absolute value of the t-value because the error is increased. 
```{r}
